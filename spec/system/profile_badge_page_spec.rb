    ...
    context "when badge is published" do
      ...
      context "when user has earned the badge" do
        context "when user has not earned the badge" do
          let!(:score) { create(:badge_badge_score, badge:, user:, value: 0, level: 0) }
        ...
        context "when user has earned the level 1 badge" do
          let!(:score) { create(:badge_badge_score, badge:, user:, value: 2, level: 1) }
        ...
        context "when user has earned the level 2 badge" do
          let!(:score) { create(:badge_badge_score, badge:, user:, value: 5, level: 2) }
        ...
        context "when user has earned the level 3 badge" do
          let!(:score) { create(:badge_badge_score, badge:, user:, value: 7, level: 3) }
        ...
        context "when user has earned the level 4 badge" do
          let!(:score) { create(:badge_badge_score, badge:, user:, value: 10, level: 4) }
        ...
        context "when user has earned the level 5 badge" do
          let!(:score) { create(:badge_badge_score, badge:, user:, value: 41, level: 5) }
        ...
        context "when user is hyperactive" do
          let!(:score) { create(:badge_badge_score, badge:, user:, value: 41_000, level: 5) }
